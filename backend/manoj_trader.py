"""Manoj Yadava's custom Trader using a multi-specialist research team."""
...
class ManojTrader(Trader):
    """Trader that consults Manoj's research team before making a decision.
    ...
    async def create_agent(
        ...
        """Create Manoj's Trader with the multi-specialist research team tool."""
    ...
    async def get_strategy(self) -> str:
        """Read Manoj's strategy through the central account resource."""
    ...
    async def run_with_mcp_servers(self) -> str:
        """Open isolated tool bundles for Manoj's Trader and specialists."""

        async with AsyncExitStack() as stack:
            trader_servers = [
                await stack.enter_async_context(server)
                for server in manoj_trader_mcp_servers()
            ]
            researcher_servers = [
                await stack.enter_async_context(server)
